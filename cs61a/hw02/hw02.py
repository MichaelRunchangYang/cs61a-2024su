...
def digit_distance(n):
    ...
    if n < 10:
        ...
        return abs((n % 10) - (n % 100 - n % 10) // 10) + digit_distance(n // 10)
...
def interleaved_sum(n, odd_func, even_func):
    ...
    def from_odd(k):
        if k == n:
            ...
            return odd_func(k) + even_func(k + 1) + from_odd(k + 2)
    return from_odd(1)
...
def count_coins(total):
    ...
    def largest_coin(total, coin):
        if total == 0:
            ...
            return largest_coin(total - coin, coin) + largest_coin(total, next_smaller_coin(coin))
    return largest_coin(total, coin)
